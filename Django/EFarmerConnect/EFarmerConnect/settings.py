...
CSRF_COOKIE_SAMESITE = 'Lax'  # Can be 'Lax' or 'None' if using HTTPS
...
# For development only - in production, use proper domain and HTTPS
...
REST_FRAMEWORK = {
    ...
    # During local development we allow open access; switch to stricter
